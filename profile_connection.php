   ...
   <body class="clinic_version">
      ...
      <header>
         <div class="header-top wow fadeIn">
            <div class="container">
               <a class="navbar-brand" href="index.html"><img src="./images/medilocker2.png" alt="Medilocker"></a>
               <div class="right-header">
                  <div class="header-info">
                     ...
                     <div class="info-inner">
                        ...
                        <span class="iconcont"><a data-scroll href="mailto:medilocker@gmail.com">medilocker@gmail.com</a></span>    
                     </div>
                     <div class="info-inner">
               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        <!-- <li><a class="active" href="./Mail/email.php">mail</a></li> -->
                        <li><a class="active" href="index.html">Home</a></li>
                        <li><a data-scroll href="#about">About us</a></li>
                        <li><a data-scroll href="#service">Appointments</a></li>
                        
                        
                            <li><a data-scroll href="#testimonials">Testimonials</a></li>
                        <li><a data-scroll href="profile.html">My Profile</a></li>
               ...
               <div class="col-md-12 col-sm-12">
                  <div class="text-contant">
                     <h2>
                        ...
                        <a href="" class="typewrite" data-period="2000" data-type='[ "Welcome to Medilocker", "We Care Your Health", "We are Expert!" ]'>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
               <div class="row">
                  <div class="service-time one" style="background:#2895f1;">
                     ...
                     <p>No need to rush for your medical records anymore. Just a QR code can give your medical records.</p>
                  </div>
               </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
               <div class="row">
                  <div class="service-time middle" style="background:#0071d1;">
                     ...
                     <div class="time-table-section">
                        <p><span >Always available. (24/7 access) </span></p>
                           <p>No need to carry those papers of medical records with you. Medilocker is easy and handy.</p>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
               <div class="row">
                  <div class="service-time three" style="background:#0060b1;">
                     ...
                     <h3>Security</h3>
                     <p>Don't worry. We keep your records secure and safe.</p>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="message-box">
                     ...
                     <p class="lead">Medilocker keeps track of all your medical records safely and efficiently. You can easily upload the photos of your transcripts by the doctor or any test report. You can access them anytime you require. Along with that add the appointment details , if you have any , we will notify you by email and message so that you won't skip your regular checkups. </p>
               ...
               <div class="col-md-6">
                  <div class="post-media wow fadeIn">
                     ...
                     <a href="#" class="playbutton"><i class="flaticon-play-button"></i></a>
                  </div>
                  <!-- end media -->
               </div>
               <!-- end col -->
      ...
      <div id="profile" class="section wow fadeIn">
         <div class="container">
            <div class="heading">
               <span class="icon-logo"><img src="images/icon-logo.png" alt="#"></span>
               <h2>My Profile</h2>
            ...
            <div class="row">
                  ...
                  <div class="inner-services">
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="serv">
                           ...
                           <h4>APPOINMENTS NOTIFICATION</h4>
                           <p>Lorem Ipsum is simply dummy text of the printing.</p>
                        </div>
                     </div>
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
               ...
               <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                  <div class="appointment-form">
                     <h3><span>+</span> ADD Appointment</h3>
                     <div class="form">
                        <form action="index.html">
                           <fieldset>
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 <div class="row">
                                    <div class="form-group">
                                       <input type="text" id="name" placeholder="Appointment Name"  />
                                    </div>
                                 </div>
                              </div>
                              <!-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 select-section">
                                 <div class="row">
                                    <div class="form-group">
                                       <input type="date" placeholder="date" id="data" />
                                    </div>
                                    <!-- <div class="form-group">
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-md-6 col-sm-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                  <div class="testimonial clearfix">
                     <div class="desc">
                        <h3><i class="fa fa-quote-left"></i> The amazing application! Wonderful Support!</h3>
                        <p class="lead">They have managed my records efficiently , a sed highly skilled, and experienced & professional team.</p>
                     </div>
                     <div class="testi-meta">
                        <img src="images/testi_01.png" alt="" class="img-responsive alignleft">
                        <h4>James Fernando <small>- User of Medilocker</small></h4>
                     </div>
                     <!-- end testi-meta -->
                  </div>
                  <!-- end testimonial -->
               ...
               <div class="col-md-6 col-sm-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                  <div class="testimonial clearfix">
                     <div class="desc">
                        <h3><i class="fa fa-quote-left"></i> Thanks for Helping us!</h3>
                        <p class="lead">Keeping track of my medical records was such a trouble. It's easy to manage with Medilocker.</p>
                     </div>
                     <div class="testi-meta">
                        <img src="images/testi_02.png" alt="" class="img-responsive alignleft">
                        <h4>Andrew Atkinson <small>- User of Medilocker</small></h4>
                     </div>
                     <!-- end testi-meta -->
                  </div>
                  <!-- end testimonial -->
            ...
            <div class="row">
               <div class="col-md-6 col-sm-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.6s">
                  <div class="testimonial clearfix">
                     <div class="desc">
                        <h3><i class="fa fa-quote-left"></i> I used to forgot my appointments and checkups. Medilocker gives prior notifications to the appointments.</p>
                     </div>
                     <div class="testi-meta">
                        <img src="images/testi_03.png" alt="" class="img-responsive alignleft">
                        <h4>Amanda DOE <small>- User of Medilocker</small></h4>
                     </div>
                     <!-- end testi-meta -->
                  </div>
                  <!-- end testimonial -->
               ...
               <div class="col-md-6 col-sm-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                  <div class="testimonial clearfix">
                     <div class="desc">
                        <h3><i class="fa fa-quote-left"></i> Thanks for Helping us!</h3>
                        <p class="lead">It's easy to share my records with the hospital teams. </p>
                     </div>
                     <div class="testi-meta">
                        <img src="images/testi_01.png" alt="" class="img-responsive alignleft">
                        <h4>Martin Johnson <small>- User of Medilocker</small></h4>
                     </div>
                     <!-- end testi-meta -->
                  </div>
                  <!-- end testimonial -->
            ...
            <div class="row">
               <div class="col-md-4">
                  <div class="logo padding">
                     <a href=""><img src="images/medilocker.png" alt=""></a>
                     <p>We believe technology can make life easier. </p>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="footer-info padding">
                     <h3>CONTACT US</h3>
                     <p><i class="fa fa-map-marker" aria-hidden="true"></i> IGDTUW, Kashmere Gate , New Delhi</p>
                     <p><i class="fa fa-paper-plane" aria-hidden="true"></i> medilocker@gmail.com</p>
            ...
            <div class="row">
               <div class="col-md-8">
                  <div class="footer-text">
                     <p>© 2020 Medilocker. All Rights Reserved.</p>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="social">
